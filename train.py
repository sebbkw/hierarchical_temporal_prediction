...
models = {
    ...
    'network_hierarchical_feedforward'     : NetworkHierarchicalFeedforward,
    'network_hierarchical_recurrent'       : NetworkHierarchicalRecurrent,
}

datasets = {
    # Define your paths to the dataset used to train here
}
...
def main (hyperparameters={}, path=None):
    ...
    if path:
        ...
        Network = models['network_hierarchical_recurrent']
